...
def parse_args():
    ...
    p = argparse.ArgumentParser(
        description="IzmirWildfire2025 – Sentinel-2 NDVI/NBR dNDVI/dNBR analizi"
    )
    ...
    p.add_argument("--aoi", default="src/aoi.geojson", help="AOI GeoJSON dosyası (opsiyonel)")
    ...
    p.add_argument("--project", default="karabukwildfire2025", help="Earth Engine proje ID (varsayılan: karabukwildfire2025)")
    return p.parse_args()
