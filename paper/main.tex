...
\author{Yusuf Talha ARABACI\\İzmir Üniversitesi\\Yüksek Lisans, Yazılım Mühendisliği Öğrencisi}
\date{Tarih: \today}
...
Bu çalışmada pipeline, öncesi için \texttt{2025-08-15--2025-08-31}, sonrası için \texttt{2025-09-01--2025-09-20} tarih aralıklarıyla çalıştırılmıştır. Üretilen \texttt{results/summary\_stats.csv} dosyasındaki değerler rapordaki özet istatistik tablosu ve yorumlarda kullanılmıştır.
