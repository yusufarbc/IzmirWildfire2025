...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics{../results/pre_NBR.png}}
    \caption{Pre NBR}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics{../results/post_NBR.png}}
    \caption{Post NBR}
  \end{subfigure}
...
\begin{table}[H]
  ...
  Ölçüt & Değer \\ \midrule
  % CSV satırları pgfplotstable'a geçirildi; bu satır kaldırıldı.
  \\ \bottomrule
  \end{tabular}
