...
RGB karşılaştırması (\autoref{fig:rgb}), dNBR ve şiddet haritaları (\autoref{fig:diffs}) gözlemleri ile sayısal özetlerin tutarlılığı kontrol edilmiştir. Bir sonraki çalışmada saha gözlemleri ve bağımsız BA ürünleri ile nicel doğrulama planlanmaktadır.
